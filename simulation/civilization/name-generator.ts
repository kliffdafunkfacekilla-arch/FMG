...
const ERROR = false;
const WARN = false;
const tip = (_msg: string, _err?: boolean, _mode?: string) => {};

const pack = { cultures: [] as any[] };
const _mapName = { value: "" };
const locked = (_name: string) => false;
const unlock = (_name: string) => {};
...
export const legacyNameBases: any[] = [
	{
		name: "French",
		i: 0,
		min: 4,
