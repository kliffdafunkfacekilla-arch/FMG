...
export function mountLayersPanel(containerId: string) {
  ...
  document.addEventListener("keydown", (e) => {
    ...
    switch (e.key.toUpperCase()) {
      case "G": targetKey = "showGrid"; break;
      case "R": targetKey = "showRivers"; break;
      case "T": targetKey = "showRoutes"; break;
      case "B": targetKey = "showBurgs"; break;
      case "M": targetKey = "showMilitary"; break;
      case "K": targetKey = "showMarkers"; break;
      case "L": targetKey = "showLabels"; break;
      case "Z": targetKey = "showZones"; break;
    }
